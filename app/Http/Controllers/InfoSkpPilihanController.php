...
class InfoSkpPilihanController extends Controller
{
    public function infoskp()
    {
        ...
        if (Auth::guard('mahasiswa')->user()->jenjang_pendidikan == 'Sarjana'){
            ...
            $info = SkpPilihan::Latest()->where ('jenjang_pendidikan', '=', 'Sarjana') ->get();
            ...
            $info = SkpPilihan::Latest()->where ('jenjang_pendidikan', '=', 'Diploma') ->get();
            ...
            $info = SkpPilihan::Latest()->where ('jenjang_pendidikan', '=', 'Magister') ->get();
            ...
            $info = SkpPilihan::Latest()->where ('jenjang_pendidikan', '=', 'Doktor') ->get();
            ...
            $info = SkpPilihan::Latest()->where ('jenjang_pendidikan', '=', 'Profesi') ->get();
