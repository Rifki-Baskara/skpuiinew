            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/prodi/peserta/storeP" method="POST" id="formInput">
                            @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="penyelenggara" value="{{Auth::user()->nama}}" class="form-control" name="penyelenggara" readonly>
                                                @error('penyelenggara')
                                                <div class="invalid-feedback"> {{$message}} </div>
                                                @enderror
                                            </div>
