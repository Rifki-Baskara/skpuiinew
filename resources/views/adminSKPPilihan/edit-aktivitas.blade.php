                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <ol class="breadcrumb text-left">
                            ...
                            <li><a href="/adminskppilihan/aktivitas-kemahasiswaan/">Aktivitas Kemahasiswaan</a></li>
    ...
    <div class="content">
		...
		<div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-title">Tambah Aktivitas Kemahasiswaan </h4>
                        <hr color="yellow">
                        @if (session('status'))
                        ...
                        <form action="/adminskppilihan/aktivitas-kemahasiswaan/update/{{ $domain->id}}" method="POST">
							@csrf
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <a href="/adminskppilihan/aktivitas-kemahasiswaan/" class="btn btn-secondary" >Cancel</a>
